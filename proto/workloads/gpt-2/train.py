...
def train():
    ...
    parser.add_argument("--model_checkpoint", type=str, default="runs/CDial-GPT_LCCC-large", help="Path or URL of the model")
    parser.add_argument("--from_step", type=int, default=-1, help="Init learning rate from this step")
    parser.add_argument('--pretrained', action='store_true', default=True, help="If False train from scratch") #action='store_true'
    parser.add_argument("--data_path", type=str, default="/home/ubuntu/STC.json",
